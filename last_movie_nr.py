...
def make_page(urls):
    ...
    buffer+='.synop {font-size: 12px;border:dotted;margin-left:1px; margin-right:1px;padding-top: 10px; padding-right: 15px;}ul {padding-inline-end: 15px;padding-inline-start: 27px;}'
